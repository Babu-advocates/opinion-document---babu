        ...
        <table style={{ 
          ...
          <thead>
            <tr style={{ backgroundColor: '#f0f0f0' }}>
              ...
              <th style={{ border: '1px solid #000', padding: '6pt', textAlign: 'left', fontWeight: 'bold' }}>Dt & D.No</th>
          ...
          <tbody>
            {validDeeds.map((deed, index) => <tr key={deed.id}>
                ...
                <td style={{ border: '1px solid #000', padding: '6pt' }}>{deed.date || '-'} / {deed.document_number || '-'}</td>
