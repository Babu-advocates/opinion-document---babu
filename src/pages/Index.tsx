...
import { FileText, Download, Scale, LogIn, ArrowLeft } from "lucide-react";
...
const Index = () => {
  ...
  const generateWordTableXml = (validDeeds: Deed[]) => {
    ...
    validDeeds.forEach((deed, index) => {
      ...
      const dateAndDocNo = escapeXml(`${deed.date || '-'} / ${deed.document_number || '-'}`);
      ...
      tableRows += `
        <w:tr>
          ...
          <w:tc>
            ...
            <w:p><w:r><w:t>${dateAndDocNo}</w:t></w:r></w:p>
          </w:tc>
          <w:tc>
    ...
    return `<w:tbl>
        ...
        <w:tr>
          ...
          <w:tc>
            <w:tcPr><w:tcW w:w="1800" w:type="dxa"/></w:tcPr>
            <w:p><w:r><w:rPr><w:b/></w:rPr><w:t>Dt &amp; D.No</w:t></w:r></w:p>
          </w:tc>
          <w:tc>
            <w:tcPr><w:tcW w:w="4800" w:type="dxa"/></w:tcPr>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <Button variant="outline" onClick={() => navigate("/auth")} className="bg-background/10 border-background/20 hover:bg-background/20">
